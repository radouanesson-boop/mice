...
$args = wp_parse_args(
	$args ?? array(),
	array(
		'kicker'         => get_theme_mod( 'vm_cta_kicker', __( 'Marrakech Convention Bureau', 'vm' ) ),
		'title'          => get_theme_mod( 'vm_cta_title', __( 'Let’s plan something extraordinary', 'vm' ) ),
		'description'    => get_theme_mod( 'vm_cta_description', __( 'Tell us about your event. We come back within 48 hours with venues, ideas and a dedicated contact — at no cost.', 'vm' ) ),
		'primary_text'   => get_theme_mod( 'vm_cta_button_text', __( 'Submit an RFP', 'vm' ) ),
		'primary_url'    => get_theme_mod( 'vm_cta_button_url', home_url( '/submit-rfp/' ) ),
		'secondary_text' => get_theme_mod( 'vm_cta_button2_text', __( 'Talk to the Bureau', 'vm' ) ),
		'secondary_url'  => get_theme_mod( 'vm_cta_button2_url', home_url( '/contact/' ) ),
		'image_id'       => (int) get_theme_mod( 'vm_cta_image', 0 ),
	)
);
?>
