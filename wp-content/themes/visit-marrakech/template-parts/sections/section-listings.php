...
// Map the design "kind" to its DMF listing post type.
$mcb_type_map = apply_filters(
	'vm/kind_post_types',
	array(
		'venue'      => 'dmf_venue',
		'hotel'      => 'dmf_hotel',
		'restaurant' => 'dmf_restaurant',
		'experience' => 'dmf_experience',
		'event'      => 'dmf_event',
		'supplier'   => 'dmf_supplier',
	)
);

$mcb_query = mcb_listing_query(
	array(
		'type'     => isset( $mcb_type_map[ $args['kind'] ] ) ? array( $mcb_type_map[ $args['kind'] ] ) : array(),
		'count'    => $args['count'],
