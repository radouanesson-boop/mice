...
$args = wp_parse_args(
	...
	array(
		...
		'title_before'    => get_theme_mod( 'mcb_hero_title_before', __( 'Where the world meets ', 'mcb' ) ),
		'title_em'        => get_theme_mod( 'mcb_hero_title_em', __( 'Marrakech', 'mcb' ) ),
		'title_after'     => get_theme_mod( 'mcb_hero_title_after', '' ),
		'description'     => get_theme_mod( 'mcb_hero_description', __( 'Africa’s rising capital for meetings, incentives, congresses and events — supported end to end by the Marrakech Convention Bureau.', 'mcb' ) ),
		'primary_text'    => __( 'Submit an RFP', 'mcb' ),
		'primary_url'     => home_url( '/submit-rfp/' ),
		'secondary_text'  => __( 'Explore the destination', 'mcb' ),
...
$mcb_stats = apply_filters(
	'mcb/hero_stats',
	array(
		array( 'value' => __( '3', 'mcb' ), 'label' => __( 'Convention centres', 'mcb' ) ),
		array( 'value' => __( '1,000s', 'mcb' ), 'label' => __( 'Five-star rooms', 'mcb' ) ),
		array( 'value' => __( '3h', 'mcb' ), 'label' => __( 'From Europe', 'mcb' ) ),
	)
);
