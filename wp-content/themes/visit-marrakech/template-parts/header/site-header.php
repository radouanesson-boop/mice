 ...
 * via Appearance → Menus, CTA via theme mods / `vm/header_cta`, languages
...
<header class="mcb-header" data-mcb-header>
	...
	<?php if ( has_nav_menu( 'vm_topbar' ) ) : ?>
		<div class="mcb-topbar">
			<div class="mcb-container mcb-topbar__inner">
				...
				<nav class="mcb-topbar__nav" aria-label="<?php esc_attr_e( 'Quick links', 'vm' ); ?>">
					<?php
					wp_nav_menu(
						array(
							'theme_location' => 'vm_topbar',
							'container'      => false,
	...
	<div class="mcb-header__bar">
		<div class="mcb-container mcb-header__inner">
			...
			<nav class="mcb-nav" id="mcb-primary-nav" aria-label="<?php esc_attr_e( 'Primary', 'vm' ); ?>">
				<?php
				wp_nav_menu(
					array(
						'theme_location' => 'vm_primary',
						'container'      => false,
			...
			<div class="mcb-header__actions">
				...
				<a class="mcb-header__search" href="<?php echo esc_url( home_url( '/?s=' ) ); ?>" aria-label="<?php esc_attr_e( 'Search', 'vm' ); ?>">
					<?php mcb_icon( 'search' ); ?>
				</a>
				...
				<button class="mcb-burger" type="button" data-mcb-nav-toggle
					...
					aria-label="<?php esc_attr_e( 'Open menu', 'vm' ); ?>">
