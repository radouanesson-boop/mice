 ...
 *
 * Data: `vm/trust_items` filter (array of strings) so the client's team
 * can manage it from a small config or a block pattern instead.
 *
 * @package MCB
 */
...
$mcb_label = apply_filters( 'vm/trust_label', __( 'Trusted to host the world’s leading events', 'vm' ) );
?>
<div class="mcb-trust">
