...
$mcb_location = has_nav_menu( 'vm_mobile' ) ? 'vm_mobile' : 'vm_primary';
...
<div class="mcb-mobile-nav" id="mcb-mobile-nav" data-mcb-mobile-nav hidden>
	...
	<div class="mcb-mobile-nav__panel" role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'Site menu', 'vm' ); ?>">
		<div class="mcb-mobile-nav__head">
			<span class="mcb-mobile-nav__brand"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></span>
			<button class="mcb-mobile-nav__close" type="button" data-mcb-nav-close aria-label="<?php esc_attr_e( 'Close menu', 'vm' ); ?>">
				<?php mcb_icon( 'close' ); ?>
			</button>
		</div>

		<nav class="mcb-mobile-nav__nav" aria-label="<?php esc_attr_e( 'Mobile', 'vm' ); ?>">
			<?php
